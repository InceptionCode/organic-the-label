...
export type NavbarProps = {
    navLinks: { name: string, href: string, current: boolean }[]
}
                ...
                {navLinks.map((item) => (
                  <Link
                    ...
                    className={classNames(
                      item.current ? 'border-b-2 border-red-500 text-white' : 'text-gray-300 hover:text-white hover:border-b-2 hover:border-red-300',
