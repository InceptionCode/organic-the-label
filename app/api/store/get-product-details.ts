...
export type GetProductDetailFetchState = {
  product: Product & {
    ...
    audioPreviewMetafield: ProductsDetailResponse["product"]["audioPreviewMetafield"];
    whatsIncludedMetafield: ProductsDetailResponse["product"]["whatsIncludedMetafield"];
  };
  error: Error | null;
};
