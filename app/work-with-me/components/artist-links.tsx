          ...
          return (
            <li key={`${link.platform}-${link.label}`}>
              <a
                ...
                className="group inline-flex items-center gap-2.5 rounded-full border px-4 py-2.5 text-body-s transition-soft focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--accent-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--bg-canvas)]"
                style={{
                  minHeight: "44px",
